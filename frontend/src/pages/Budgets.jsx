        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-500 font-medium mt-1">Manage your monthly spending limits</p>
                </div>
                <button
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                {budgets.length === 0 ? (
                    ...
                    budgets.map((budget) => {
                        ...
                        return (
                            <div key={budget.id} className="bg-white/80 backdrop-blur-xl p-6 rounded-3xl border border-white/40 shadow-glass group relative overflow-hidden">
                                <div className="flex justify-between items-start mb-4">
                                    <div className="flex items-center gap-3">
                                        <div className="w-10 h-10 rounded-2xl bg-brand-50 flex items-center justify-center text-brand-600 font-bold border border-brand-100">
